...
class TestAwsEc2Count(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_init_config = Mock()
        self.mock_init_config.get.return_value = 'aws_ec2_count'
        aws_ec2_count.AwsEc2Count.init_config = self.mock_init_config
    ...
    def test_check(self):
        ...
        self.assert_gauge( 1, call('aws_ec2_count.reserved.count',             1.0, tags=['ac-az:region-1a', 'ac-type:c4.large',  'ac-family:c4']))
        self.assert_gauge( 2, call('aws_ec2_count.reserved.footprint',         4.0, tags=['ac-az:region-1a', 'ac-type:c4.large',  'ac-family:c4']))
        self.assert_gauge( 3, call('aws_ec2_count.reserved.count',             2.0, tags=['ac-az:region-1a', 'ac-type:c4.xlarge', 'ac-family:c4']))
        self.assert_gauge( 4, call('aws_ec2_count.reserved.footprint',        16.0, tags=['ac-az:region-1a', 'ac-type:c4.xlarge', 'ac-family:c4']))
        self.assert_gauge( 5, call('aws_ec2_count.running.count',              1.0, tags=['ac-az:region-1a', 'ac-type:c4.large',  'ac-family:c4']))
        self.assert_gauge( 6, call('aws_ec2_count.running.footprint',          4.0, tags=['ac-az:region-1a', 'ac-type:c4.large',  'ac-family:c4']))
        self.assert_gauge( 7, call('aws_ec2_count.running.count',              2.0, tags=['ac-az:region-1a', 'ac-type:c4.xlarge', 'ac-family:c4']))
        self.assert_gauge( 8, call('aws_ec2_count.running.footprint',         16.0, tags=['ac-az:region-1a', 'ac-type:c4.xlarge', 'ac-family:c4']))
        self.assert_gauge( 9, call('aws_ec2_count.ondemand.count',             5.0, tags=['ac-az:region-1a', 'ac-type:m4.large',  'ac-family:m4']))
        self.assert_gauge(10, call('aws_ec2_count.ondemand.footprint',        20.0, tags=['ac-az:region-1a', 'ac-type:m4.large',  'ac-family:m4']))
        self.assert_gauge(11, call('aws_ec2_count.ondemand.count',             6.0, tags=['ac-az:region-1a', 'ac-type:m4.xlarge', 'ac-family:m4']))
        self.assert_gauge(12, call('aws_ec2_count.ondemand.footprint',        48.0, tags=['ac-az:region-1a', 'ac-type:m4.xlarge', 'ac-family:m4']))
        self.assert_gauge(13, call('aws_ec2_count.reserved_unused.count',      7.0, tags=['ac-az:region-1a', 'ac-type:m3.large',  'ac-family:m3']))
        self.assert_gauge(14, call('aws_ec2_count.reserved_unused.footprint', 28.0, tags=['ac-az:region-1a', 'ac-type:m3.large',  'ac-family:m3']))
        self.assert_gauge(15, call('aws_ec2_count.reserved_unused.count',      8.0, tags=['ac-az:region-1a', 'ac-type:m3.xlarge', 'ac-family:m3']))
        self.assert_gauge(16, call('aws_ec2_count.reserved_unused.footprint', 64.0, tags=['ac-az:region-1a', 'ac-type:m3.xlarge', 'ac-family:m3']))
